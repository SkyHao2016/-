...
class RscStructuredText_SkyhHao
{
	deletable = 0;
	fade = 0;
	access = 0;
...
class RscShortcutButton_SkyhHao
{
	deletable = 0;
	fade = 0;
	type = 16;
...
class RscShortcutButtonMain_SkyhHao
{
	idc = -1;
	style = 0;
	default = 0;
...
class RscButtonMenuCancel_SkyhHao
{
	idc = 2;
	shortcuts[] = 
	{
...
class RscControlsGroup_SkyhHao
{
	deletable = 0;
	fade = 0;
	class VScrollbar

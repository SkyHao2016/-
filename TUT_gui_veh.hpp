...
class RscTUTVehDialog
{
	...
	objects[]={};
	class vehBack: IGUIBack_SkyhHao
{
	idc = 0;
	...
	class vehFrame: IGUIBack_SkyhHao
{
	idc = 1;
	...
	class RscHeaderBack: IGUIBack_SkyhHao
{
	idc = 2;
	...
	class RscVehBack: IGUIBack_SkyhHao
{
	idc = 3;
	x = 0.255 * safezoneW + safezoneX;
	...
	class RscVehInfoBack: IGUIBack_SkyhHao
{
	idc = 4;
...
class btnCancel: RscShortcutButton_SkyhHao
{
	idc = 5;
	text = "召唤载具";
	...
	class btnConfirm: RscShortcutButton_SkyhHao
{
	idc = 6;
	text = "回收载具";
    colorBackground[] = {0.4,0.4,0.4,1}; 
	colorBackground2[] = {0.4,0.4,0.4,1}; 
	colorBackgroundFocused[] = {0.4,0.4,0.4,1};
	onButtonClick  = "[] call TUT_gui_VehDelete;";
	x = 0.625 * safezoneW + safezoneX;
	y = 0.7025 * safezoneH + safezoneY;
	w = 0.12 * safezoneW;
	h = 0.0375 * safezoneH;
};
	class RscVehList: RscListBox_SkyhHao
{
	idc = 7;
...
class vehStatText: RscStructuredText_SkyhHao
{
	idc = 8;
	colorText[] = {1,1,1,1};
	colorBackground[] = {0.667,0.714,0.635,1};
...
class serverTitleText: RscStructuredText_SkyhHao
{
	idc = 10;
	colorText[] = {1,1,1,1};
...
class RscPlayerFlagLeft: RscPicture_SkyhHao
{
	idc = 11;
	...
	class btnLand: RscShortcutButton_SkyhHao
{
	idc = 12;
	text = "刷新载具";
    colorBackground[] = {0.4,0.4,0.4,1}; 
